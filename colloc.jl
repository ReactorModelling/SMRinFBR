...
######  jcobi  #######
function jcobi(n, n0, n1, alpha, beta)
    if n0 != 0 && n0 != 1
    ...
    return dif1, dif2, dif3, root
end
##### dfopr ######
function dfopr(n, n0, n1, i, id, dif1, dif2, dif3, root)
    nt      = n+n0+n1
    vect    = zeros(nt,1)
    if n0 != 0 && n0 != 1
        error("** VILERR : Illegal value #  N0 ")
